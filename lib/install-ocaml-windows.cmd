...
dos2unix %1\src\install-ocaml-windows.sh
bash -l %1\src\install-ocaml-windows.sh %3
unix2dos %1\src\opam.bat
mkdir %CYGWIN_ROOT%\wrapperbin
copy %1\src\opam.bat %CYGWIN_ROOT%\wrapperbin\opam.bat
